...
const tabs = [
  { name: 'gc.json', isActive: true },
  { name: 'eac.json', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                ReCert is a framework built upon our proposed Re-Certification Approach, designed to replace <strong>Energy Attribute Certificates (EACs)</strong> with Next-Generation <strong>Granular Certificates (GCs)</strong> and Decentralized GCs             
              </p>
            </div>
          </div>
